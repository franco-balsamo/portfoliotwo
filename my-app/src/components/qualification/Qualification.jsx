  ...
  return (
    <section className="qualification section">
      ...
      <div className="qualification__container container">
        ...
        <div className="qualification__sections"> {/*Gral educacion y experiencias*/}
          {/*Gral educacion*/}
          <div
            className={
              toggleState === 1
          ...
          >
            <div className="qualification__data">
              <div>
                <h3 style={{color: darkMode && "#fff"}} className="qualification__title">Instituto IEA</h3>
                <span className="qualification__subtitle">
                Bachiller Orientaciòn Gestión y Administración Especializado en Comercio Exterior.

                </span>
                <div className="qualification__calender">
                  <i className="uil uil-calendar-alt"></i> Finalizado
                </div>
              </div>
            ...
            <div className="qualification__data">
              ...
              <div>  {/*  coder - desa */}
                <h3 style={{color: darkMode && "#fff"}} className="qualification__title">CoderHouse</h3>
                <span className="qualification__subtitle">
                   Desarrollo Web
                </span>
                <div className="qualification__calender">
