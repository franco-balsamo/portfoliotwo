          ...
          <div className="contact__info">
            <div className="contact__card">
              ...
              <span style={{color: darkMode && "rgb(34, 34, 34)"}} className="contact__card-data">
                balsamote96@gmail.com
              </span>

              <a 
              href="mailto:balsamote96@gmail.com" 
              target="_blank" 
              rel="noreferrer" 
            ...
            <div className="contact__card">
              ...
              <span style={{color: darkMode && "rgb(34, 34, 34)"}} className="contact__card-data">+54 9 11 2669 7428</span>

              <a href="https://wa.me/5491126697428" 
              target="_blank" 
              rel="noreferrer" 
              className="contact__button"
              >
